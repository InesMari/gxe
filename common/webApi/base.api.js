...
// 登录
const login = params => req.postByCode('500072', params);   //微信登录
...
const codeLogin = params => req.postByCode('500073', params);   //手机验证码登录
...
const payStatus = params => req.postByCode('500074', params,undefined,false);   //支付状态，payStatus 1：正在支付中  3：支付成功  6：支付失败
